...
export const PaymentMethodsPage: React.FC = () => {
  ...
  const medioActivo = (key: string) => siteSettings.paymentMethodsEnabled.includes(key);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        {medioActivo('tarjeta') && (
          <div className="bg-white rounded-2xl border border-neutral-200 p-6 space-y-4 shadow-xs hover:shadow-md transition-shadow">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 mt-1 leading-relaxed">
                Aceptamos Visa, Mastercard, American Express y Naranja X. {siteSettings.installmentsText}.
              </p>
            </div>
            <ul className="text-xs text-neutral-600 space-y-1.5 pt-2 border-t border-neutral-100 font-mono">
              <li>• {siteSettings.installmentsText}</li>
        ...
        {medioActivo('efectivo') && (
          <div className="bg-white rounded-2xl border border-neutral-200 p-6 space-y-4 shadow-xs hover:shadow-md transition-shadow">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 mt-1 leading-relaxed">
                Aboná directamente al momento de retirar tu pedido en nuestro depósito central en El Soberbio, Misiones, sin costos de envío adicionales.
              </p>
            </div>
            <ul className="text-xs text-neutral-600 space-y-1.5 pt-2 border-t border-neutral-100 font-mono">
      ...
      {/* Garantía */}
      <div className="bg-neutral-900 text-white rounded-3xl p-6 sm:p-8 border border-neutral-800 flex items-center gap-4">
        <div className="p-3 rounded-2xl bg-amber-500/10 text-amber-400 shrink-0">
          <ShieldCheck className="w-8 h-8" />
        </div>
        <div>
          <h3 className="font-bold text-base">Garantía GIANNIZI Imports</h3>
